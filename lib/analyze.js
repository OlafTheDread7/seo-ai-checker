...
export async function analyze(finalUrl, page, preResources = null) {
  ...
  const categories = [
    { key: 'seo', title: 'SEO Fundamentals', icon: 'search', checks: seoChecks($, ctx) },
    { key: 'ai', title: 'AI Searchability', icon: 'ai', checks: aiChecks($, ctx) },
    { key: 'technical', title: 'Technical', icon: 'gear', checks: technicalChecks($, ctx) },
    { key: 'content', title: 'Content Quality', icon: 'pen', checks: contentChecks($, ctx) },
